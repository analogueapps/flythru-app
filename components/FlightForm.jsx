  ...
  return (
    <>
        ...
        <View className=" flex flex-row items-center gap-x-1 border h-[50px] border-gray-300 my-2 rounded-xl text-black px-4 py-3 bg-gray-50">
          <Text>{applanguage === "eng"
            ? Translations.eng.from
            : Translations.arb.from}:</Text>
          <TextInput
            placeholder={
              applanguage === "eng"
                ? Translations.eng.from
        ...
        >
          {showDatePicker ?
            ...
            />
            :
            <TouchableOpacity className="bg-gray-100 p-3 rounded-lg" onPress={() => setShowDatePicker(true)}>
        ...
        >
          {showTimePicker ?
            ...
            />
            :
            <TouchableOpacity className="bg-gray-100 p-3 rounded-lg" onPress={() => setShowTimePicker(true)}>

              <Text>{selectedTime || (applanguage === "eng" ? Translations.eng.flight_timing : Translations.arb.flight_timing)}</Text>
            </TouchableOpacity>
          }
