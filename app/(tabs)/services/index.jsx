        ...
        {services.length > 0 ? (
          services.map((service) => (
            <View key={service._id} className="mb-6">
              ...
              {/* Book Now Button */}
              {/* <TouchableOpacity
                className="bg-[#FFB800] rounded-xl py-4 my-4 mx-10 shadow-2xl active:opacity-80"
                activeOpacity={0.8}
    ...
    {applanguage === "eng"
      ...
      : Translations.arb.book_now}
          ...
          <Text className="text-center text-gray-500 text-lg mt-5">
            {applanguage==="eng"?Translations.eng.no_services_available:Translations.arb.no_services_available
              }
          </Text>
        )}
      </ScrollView>
