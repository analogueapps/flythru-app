            ...
            >
              <View className="flex-row items-start py-3 px-4">
                ...
                <View className="ml-2 flex flex-col items-start gap-y-1">
                  <Text className="text-gray-600 font-extrabold text-[16px]" style={{ fontFamily: "Lato" }}>
                    {booking?.driver?.driverName || "Driver not assigned"} {" "}
                  </Text>
                  <Text className="text-[#164F90] font-thin text-[14px]" style={{ fontFamily: "Lato" }}>
              ...
              <View className="flex-col justify-left text-left gap-2 items-start pt-4 py-1 px-5">
                <View className=" flex flex-row items-center gap-x-3">
                  ...
                  <View className="flex-col gap-y-2">
                    ...
                    <Text className="text-[#6a6c6e] text-[12px] text-wrap w-[100%]" style={{ fontFamily: "Lato" }}>
                ...
                <View className="flex flex-row justify-center   w-full">
                  ...
                  <TouchableOpacity
                    ...
                    className="my-4 mx-2 bg-[#FFB800] rounded-xl py-4 px-5 shadow-lg w-[45%]"
                    style={{
